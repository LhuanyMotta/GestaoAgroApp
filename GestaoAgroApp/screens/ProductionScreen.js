...
import {
  ...
  TouchableOpacity,
  StyleSheet,
  Switch, // Substituindo CheckBox por Switch
} from 'react-native';
...
const styles = StyleSheet.create({
  ...
  searchInput: {
    flex: 1,
    height: 50,
    borderColor: '#4CAF50', // Cor secundária
    borderWidth: 1,
    borderRadius: 10,
  ...
  filterButton: {
    backgroundColor: '#2E7D32', // Cor primária
    padding: 10,
    borderRadius: 10,
  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {/* Filtro de Registros de Produção */}
        <View style={styles.card}>
          <Text style={styles.title}>Filtrar Registros de Produção</Text>
          <View style={styles.filterContainer}>
            <TextInput
              style={styles.searchInput}
              placeholder="Digite o tipo de animal (ex: Bovino, Caprino)"
              value={searchTerm}
        ...
        {/* Histórico de Produção Filtrado */}
        {isFilterApplied && (
          <View style={styles.card}>
